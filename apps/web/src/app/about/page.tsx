...
import { Contributor } from '@/components/blocks/contributor'
...
const FuturePlans = [
  { desc: 'Implementing a user favorite system to save and categorize favorite images.' },
  { desc: 'Internalization by changing automatically to the user current device language.' },
  { desc: 'Mars Hover Photos NASA API implementation' },
]
...
const projectOverview =
  "AstroVista is an open-source web application that leverages NASA's Astronomy Picture of the Day (APOD) API to bring stunning space images to users every day. Our mission is to inspire curiosity about the universe and make space exploration accessible to everyone."

const features = [
  { title: 'Daily Space Images', description: 'Explore a new astronomical fetched every day.' },
  {
    title: 'Detailed Explanations',
    description: 'Learn about each image from astronomers explanation.',
  },
  {
    title: 'Gallery Archive',
    description:
      'Browse all APODs since 1995, with search, sort by title, and filter by image or video.',
  },
...
const openSource =
  "AstroVista is an open-source project, and we welcome contributions from developers and space enthusiasts alike. Whether you're a seasoned developer or just starting out, there are many ways to get involved. You can help us improve the code, add new features, or simply spread the word about our project."
...
export default function AboutUs() {
  ...
  return (
    <>
      <GridBackground
        text="About Us"
        subtitle="An open-source project bringing the wonders of space to your screen, powered by NASA's Astronomy Picture of the Day API."
      />
      <div className="mx-auto w-full md:container">
        <div className="sx:mx-3 sx:px-2 sx:py-2 mx-auto space-y-10 px-4 py-10">
          <motion.section
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="space-y-4 text-center"></motion.section>
            ...
            <TabsContent value="overview">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Explore the cosmos through daily astronomical images
                  </CardDescription>
                </CardHeader>
            ...
            <TabsContent value="tech">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Built with modern web languages and framework, components libraries and AI
                    tools.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="flex h-full flex-col justify-center">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Button asChild variant="outline">
                      <Link
                        href="https://github.com/FernaandoJr/AstroVista/blob/main/README.md"
                        target="_blank"
                        rel="noopener noreferrer">
          ...
          <motion.div
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  We&apos;re constantly working to improve AstroVista and expand its features. Some
                  of our future plans include:
                </p>
