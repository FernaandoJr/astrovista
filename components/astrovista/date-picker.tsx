...
export function DatePicker({ startYear = getYear(new Date()) - 100, endYear = getYear(new Date()), onChange }: DatePickerProps) {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-auto p-0">
        ...
        <Calendar mode="single" selected={date} onSelect={handleSelect} initialFocus month={date} onMonthChange={setDate} />
      </PopoverContent>
    </Popover>
  )
}
