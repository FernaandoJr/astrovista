...
const PaginationPreviousMobile = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
...
const PaginationNextMobile = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
...
export { Pagination, PaginationContent, PaginationLink, PaginationItem, PaginationPrevious, PaginationPreviousMobile, PaginationNext, PaginationNextMobile, PaginationEllipsis }
